  ...
  return (
    ...
    <div className="container" style={theme}>
        ...
        <div className="accordion" id="accordionExample" style={theme} >
            ...
            <h2 className="accordion-header" id="headingOne" style={theme}>
        ...
        <div className="accordion-item" style={theme}>
            <h2 className="accordion-header" id="headingTwo" style={theme}>
            ...
            <div className="accordion-item" style={theme}>
            <h2 className="accordion-header" id="headingThree" style={theme}>
        ...
        <button onClick={toggleSwitch} className="btn btn-primary">{text}</button>
        </div>
    </div>
